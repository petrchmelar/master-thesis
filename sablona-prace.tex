...
\usepackage[final]{pdfpages} % Balíček umožňující vkládat stránky z PDF souborů
...
% si settings
\usepackage{siunitx}
\sisetup{mode=text,range-phrase = {\text{~do~}}}
...
\include{text/literatni_reserse}

\include{text/image_series_preprocessing}

\include{text/image_formats}
